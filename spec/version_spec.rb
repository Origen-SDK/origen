...
describe RGen::VersionString do
  ...
  describe "Timestamp format" do
    ...
    it "can be identified as a timestamp" do
      %w(Rel20120203 sm_2012_11_02_22_02 tjc_2014_09_25_15_00).each do |tag|
        RGen::VersionString.new(tag).timestamp?.should == true
        RGen::VersionString.new(tag).semantic?.should == false
      end
    end

    it "identifies production tags" do
      %w(Rel20120203 Rel20131212).each do |tag|
        RGen::VersionString.new(tag).production?.should == true
        RGen::VersionString.new(tag).development?.should == false
      end
    end

    it "identifies development tags" do
      %w(sm_2012_11_02_22_02 th_2013_12_23_00 blah_blah_some_tag).each do |tag|
        RGen::VersionString.new(tag).development?.should == true
        RGen::VersionString.new(tag).production?.should == false
      end
    end
    ...
    describe "condition_met? method" do
      ...
      it "equal works" do
        ref = RGen::VersionString.new("sm_2012_11_02_22_02")
      ...
      it "production works" do
        RGen::VersionString.new("Rel20121102").condition_met?(:production).should == true
        RGen::VersionString.new("Rel20121102").condition_met?("production").should == true
        RGen::VersionString.new("Rel20121102").condition_met?(:prod).should == true
        RGen::VersionString.new("sm_2012_11_02_22_02").condition_met?(:production).should == false
        RGen::VersionString.new("sm_2012_11_02_22_02").condition_met?("production").should == false
        RGen::VersionString.new("sm_2012_11_02_22_02").condition_met?(:prod).should == false
      end
  ...
  describe "Semantic format" do
    ...
    it "can be identified as semantic" do
      %w(v1.2.3 v1.2.3.dev3 1.2.3 1.3.0.pre1).each do |tag|
        RGen::VersionString.new(tag).timestamp?.should == false
        RGen::VersionString.new(tag).semantic?.should == true
      end
    end
    ...
    describe "condition_met? method" do
      ...
      it "equal works" do
        ref = RGen::VersionString.new("v2.2.2")
        ...
        ref = RGen::VersionString.new("2.2.2")
      ...
      it "production works" do
        RGen::VersionString.new("v1.2.3").condition_met?(:production).should == true
        RGen::VersionString.new("v1.2.3").condition_met?("production").should == true
        RGen::VersionString.new("v1.2.3").condition_met?(:prod).should == true
        RGen::VersionString.new("v1.2.3.dev1").condition_met?(:production).should == false
        RGen::VersionString.new("v1.2.3.dev1").condition_met?("production").should == false
        RGen::VersionString.new("v1.2.3.dev1").condition_met?(:prod).should == false

        RGen::VersionString.new("1.2.3").condition_met?(:production).should == true
        RGen::VersionString.new("1.2.3").condition_met?("production").should == true
        RGen::VersionString.new("1.2.3").condition_met?(:prod).should == true
        RGen::VersionString.new("1.2.3.pre1").condition_met?(:production).should == false
        RGen::VersionString.new("1.2.3.pre1").condition_met?("production").should == false
        RGen::VersionString.new("1.2.3.pre1").condition_met?(:prod).should == false
      end
      ...
      it "components can be extracted" do
        ref = RGen::VersionString.new("v1.2.3")
        ref.major.should == 1
        ref.minor.should == 2
        ref.bugfix.should == 3
        ref.pre.should == nil

        ref = RGen::VersionString.new("1.2.3")
        ref.major.should == 1
        ref.minor.should == 2
        ref.bugfix.should == 3
        ref.pre.should == nil

        ref = RGen::VersionString.new("11.20.3.pre20")
        ref.major.should == 11
        ref.minor.should == 20
        ref.bugfix.should == 3
        ref.pre.should == 20
    ...
    specify "the minimum_version method works" do
      RGen::VersionString.minimum_version("v1.2.3").should == "v1.2.3"
      RGen::VersionString.minimum_version("== v1.2.3").should == "v1.2.3"
      RGen::VersionString.minimum_version(">= v1.2.5").should == "v1.2.5"
      RGen::VersionString.minimum_version("< v1.2.5").should == nil
      RGen::VersionString.minimum_version("<= v1.2.5").should == nil

      RGen::VersionString.minimum_version("1.2.3").should == "1.2.3"
      RGen::VersionString.minimum_version("== 1.2.3").should == "1.2.3"
      RGen::VersionString.minimum_version(">= 1.2.5").should == "1.2.5"
      RGen::VersionString.minimum_version("< 1.2.5").should == nil
      RGen::VersionString.minimum_version("<= 1.2.5").should == nil
    end

    specify "the maximum_version method works" do
      RGen::VersionString.maximum_version("v1.2.3").should == "v1.2.3"
      RGen::VersionString.maximum_version("== v1.2.3").should == "v1.2.3"
      RGen::VersionString.maximum_version("> v1.2.4").should == nil
      RGen::VersionString.maximum_version(">= v1.2.5").should == nil
      RGen::VersionString.maximum_version("<= v1.2.5").should == "v1.2.5"

      RGen::VersionString.maximum_version("1.2.3").should == "1.2.3"
      RGen::VersionString.maximum_version("== 1.2.3").should == "1.2.3"
      RGen::VersionString.maximum_version("> 1.2.4").should == nil
      RGen::VersionString.maximum_version(">= 1.2.5").should == nil
      RGen::VersionString.maximum_version("<= 1.2.5").should == "1.2.5"
    end
