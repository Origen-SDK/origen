module RGen
  module CodeGenerators
    class Semver < RGen::CodeGenerators::Base
      desc <<-END
...
END
      def create_version_file
        ...
        template 'templates/code_generators/version.rb', File.join(RGen.root, 'config', 'version.rb'), force: true
      end

      def set_configuration
        unless RGen.app.config.semantically_version
