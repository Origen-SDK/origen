module RGen
  module RevisionControl
    class DesignSync < Base
      ...
      # @example
      #
      #   RGen::RevisionControl::DesignSync.remote_check_in("#{RGen.root}/output/j750", vault: "sync://sync-15088:15088/Projects/common_tester_blocks/rgen_training/j750", tag: RGen.app.version)
      ...
      def root
        ...
        RGen.app.session.dssc["root-#{local}"] ||= begin
          root = local
          resolved = false
      ...
      def initialize_local_dir
        super
        unless initialized?
          RGen.log.debug "Initializing DSSC workspace at #{local}"
