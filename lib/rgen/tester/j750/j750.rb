module RGen
  module Tester
    ...
    #    RGen.deprecate <<-END
    #      J750 Tester in RGen core is currently being moved to a dedicated plugin,
    #      use Testers::J750 from this plugin instead of RGen::Tester::J750
    ...
    class J750
      include Tester
      include Parser
      require 'rgen/tester/j750/files'
      include Files

      autoload :Parser, 'rgen/tester/j750/parser'
      autoload :Generator, 'rgen/tester/j750/generator'
