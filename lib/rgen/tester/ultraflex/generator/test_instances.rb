    ...
    class Ultraflex
      module Generator
        class TestInstances
          ...
          TEMPLATE = "#{RGen.top}/lib/rgen/tester/ultraflex/generator/templates/instances.txt.erb"
          ...
          def add(name, type, options = {})
            ...
            RGen.interface.descriptions.add_for_test_definition(name, c)
            ins
          end
          ...
          # with the name of the group. RGen automatically appends "grp" to this name to highlight
