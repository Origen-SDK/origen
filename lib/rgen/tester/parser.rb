module RGen
  module Tester
    module Parser
      autoload :SearchableArray, 'rgen/tester/parser/searchable_array'
      autoload :SearchableHash,  'rgen/tester/parser/searchable_hash'
      autoload :DescriptionLookup,  'rgen/tester/parser/description_lookup'
