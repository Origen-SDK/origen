    ...
    class Doc
      module Generator
        class Flow
          ...
          include RGen::Tester::Generator::FlowControlAPI
          ...
          def add(type, options = {})
            ...
            collection << line unless RGen.interface.resources_mode?
            if preserve_comments
              line.description = RGen.interface.doc_comments
            else
              line.description = RGen.interface.doc_comments_consume
            end
            line
          end
          ...
          def start_section(options = {})
            ...
            l.description = desc + RGen.interface.doc_comments_consume
            collection << l
          end
