module RGen
  module Pins
    ...
    #
    # The global RGen pin bank (an instance of this class) is returned from RGen.pin_bank.
    class PinBank
      include RGen::CoreCallbacks

      # There is one pin bank per RGen thread, this clears the bank every time the target is changed
      #
      # @api private
      ...
      #
      # @return [RGen::Pins::Pin] the supplied pin object
      ...
      def delete_pin(pin)
        ...
        RGen.pin_bank.pin_groups.each do |_name, grp|
