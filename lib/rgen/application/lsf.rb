module RGen
  class Application
    ...
    class LSF
      ...
      # This method returns an instance of RGen::Application::LSF::Configuration and can
      ...
      #     RGen.config.lsf.project =  "msg.nevis"
      #   end
      #   # Change the default group
      #   RGen.config.lsf.group = "lam"
