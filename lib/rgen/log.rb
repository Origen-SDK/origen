module RGen
  # An instance of this class is instantiated as RGen.log and provides the following API
  #
  # @example
  ...
  class Log
    ...
    def console_only?
      self.class.console_only? || !RGen.app
    end
    ...
    #     RGen.log.info "This will not appear in the log file!"
    #   end
    ...
    # instantiating a new logger (mainly for use by the rgen save command)
    def self.log_file
