...
module RGen
  ...
  module Model
    ...
    included do
      ...
      include RGen::Parameters
      include RGen::Specs
    end

    module ClassMethods
      def includes_rgen_model
        true
      end
    end
    ...
    def wrap_in_controller
      c = RGen.controllers.find do |params|
    ...
    def find_specs
      ...
      if self.respond_to? :specs
        ...
        unless object_specs.nil?
          if object_specs.class == RGen::Specs::Spec
      ...
      sub_blocks.each do |_name, sb|
        ...
        unless child_specs.nil?
          if child_specs.class == RGen::Specs::Spec
