    ...
    module Exporter
      def export(name, options = {})
        ...
        File.open(file, 'w') do |f|
          export_wrap_with_namespaces(f) do |indent|
            ...
            if options[:include_sub_blocks]
              sub_blocks.each do |name, block|
                f.puts export_sub_block(name, block, indent: indent, file_path: file)
              end
              f.puts
            end
            indent -= 2
      ...
      def export_wrap_with_namespaces(file)
        file.puts '# This file was automatically generated by Origen, any hand edits will likely get overwritten'
      ...
      def export_sub_block(id, block, options = {})
        ...
        block.export(id, file_path: options[:file_path].sub_ext('').to_s)
        line
      end
    end
  end
