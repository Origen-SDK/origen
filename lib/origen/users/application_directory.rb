module Origen
  module Users
    ...
    class ApplicationDirectory
      ...
      def lookup(user_or_core_id = Origen.current_user)
      ...
      #
      #   Origen.fsl.find_by_name("Stephen McGinty")
      ...
      def display(user_or_core_id = Origen.current_user)
      ...
      def authenticate(options = {})
        ...
        core_id = Origen.current_user.core_id
        authenticated = false
        timeout = false
        x = 0
      ...
      def alias_for(name)
        Origen.app.config.user_aliases.each do |nick, real|
